  ...
  return (
    <div>
      <h2 id="livraison-heading" data-cy="LivraisonHeading">
        <Translate contentKey="coopCycleApp.livraison.home.title">Livraisons</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="coopCycleApp.livraison.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/livraison/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="coopCycleApp.livraison.home.createLabel">Create new Livraison</Translate>
          </Link>
        </div>
      </h2>
        ...
        {livraisonList && livraisonList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="coopCycleApp.livraison.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="coopCycleApp.livraison.idLivraison">Id Livraison</Translate>
                </th>
                <th>
                  <Translate contentKey="coopCycleApp.livraison.prixLivraison">Prix Livraison</Translate>
                </th>
                <th>
                  <Translate contentKey="coopCycleApp.livraison.date">Date</Translate>
                </th>
                <th>
                  <Translate contentKey="coopCycleApp.livraison.adresseLivraison">Adresse Livraison</Translate>
                </th>
                <th>
                  <Translate contentKey="coopCycleApp.livraison.client">Client</Translate>
                </th>
                <th>
                  <Translate contentKey="coopCycleApp.livraison.livreur">Livreur</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {livraisonList.map((livraison, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{livraison.date ? <TextFormat type="date" value={livraison.date} format={APP_DATE_FORMAT} /> : null}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="coopCycleApp.livraison.home.notFound">No Livraisons found</Translate>
            </div>
          )
        )}
      </div>
