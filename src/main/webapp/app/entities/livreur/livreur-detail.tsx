    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="idLivreur">
              <Translate contentKey="coopCycleApp.livreur.idLivreur">Id Livreur</Translate>
            </span>
          </dt>
          <dd>{livreurEntity.idLivreur}</dd>
          <dt>
            <span id="nomLivreur">
              <Translate contentKey="coopCycleApp.livreur.nomLivreur">Nom Livreur</Translate>
            </span>
          </dt>
          <dd>{livreurEntity.nomLivreur}</dd>
          <dt>
            <span id="prenomLivreur">
              <Translate contentKey="coopCycleApp.livreur.prenomLivreur">Prenom Livreur</Translate>
            </span>
          </dt>
          <dd>{livreurEntity.prenomLivreur}</dd>
          <dt>
            <span id="telLivreur">
              <Translate contentKey="coopCycleApp.livreur.telLivreur">Tel Livreur</Translate>
            </span>
          </dt>
          <dd>{livreurEntity.telLivreur}</dd>
          <dt>
            <Translate contentKey="coopCycleApp.livreur.association">Association</Translate>
          </dt>
