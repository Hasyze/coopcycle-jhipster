        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('coopCycleApp.client.idClient')}
                id="client-idClient"
                name="idClient"
                data-cy="idClient"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('coopCycleApp.client.prenomClient')}
              ...
              />
              <ValidatedField
                label={translate('coopCycleApp.client.nomClient')}
                id="client-nomClient"
                name="nomClient"
                data-cy="nomClient"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('coopCycleApp.client.adresseClient')}
