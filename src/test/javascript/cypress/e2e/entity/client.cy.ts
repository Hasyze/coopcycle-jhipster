...
describe('Client e2e test', () => {
  ...
  describe('new Client page', () => {
    ...
    it('should create an instance of Client', () => {
      ...
      cy.get(`[data-cy="prenomClient"]`).type('Uganda b connect').should('have.value', 'Uganda b connect');

      cy.get(`[data-cy="nomClient"]`).type('c calculating primary').should('have.value', 'c calculating primary');
