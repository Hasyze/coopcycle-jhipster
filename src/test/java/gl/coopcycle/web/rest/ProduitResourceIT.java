...
import gl.coopcycle.repository.ProduitRepository;
import gl.coopcycle.service.dto.ProduitDTO;
import gl.coopcycle.service.mapper.ProduitMapper;
...
class ProduitResourceIT {
    ...
    void getAllProduits() throws Exception {
        ...
        restProduitMockMvc
            ...
            .andExpect(jsonPath("$.[*].prixProd").value(hasItem(DEFAULT_PRIX_PROD.doubleValue())));
    }
    ...
    void getProduit() throws Exception {
        ...
        restProduitMockMvc
            ...
            .andExpect(jsonPath("$.prixProd").value(DEFAULT_PRIX_PROD.doubleValue()));
    }
